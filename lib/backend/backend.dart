...
import 'schema/my_project_record.dart';
...
export 'schema/my_project_record.dart';
...
/// Functions to query MyProjectRecords (as a Stream and as a Future).
Stream<List<MyProjectRecord>> queryMyProjectRecord(
        {Query Function(Query) queryBuilder,
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollection(MyProjectRecord.collection, MyProjectRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);

Future<List<MyProjectRecord>> queryMyProjectRecordOnce(
        {Query Function(Query) queryBuilder,
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollectionOnce(MyProjectRecord.collection, MyProjectRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);

Future<FFFirestorePage<MyProjectRecord>> queryMyProjectRecordPage({
  Query Function(Query) queryBuilder,
  DocumentSnapshot nextPageMarker,
  int pageSize,
  bool isStream,
