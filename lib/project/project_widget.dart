          ...
          Expanded(
            child: StreamBuilder<List<ProjectsRecord>>(
              ...
              builder: (context, snapshot) {
                ...
                List<ProjectsRecord> listViewProjectsRecordList = snapshot.data;
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              fit: BoxFit.cover,
                              image: Image.network(
                                listViewProjectsRecord.urlImage,
                              ).image,
                            ),
                            borderRadius: BorderRadius.circular(8),
                          ),
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Expanded(
                                        child: Text(
                                          listViewProjectsRecord.descripcion,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyText2
                                              .override(
                                                fontFamily: 'Lexend Deca',
